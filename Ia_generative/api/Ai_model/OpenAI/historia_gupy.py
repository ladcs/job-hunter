...
Sua tarefa é gerar um resumo profissional curto, respondendo a pergunta "Fale sobre você e sua trajetória profissional, contando como pode ajudar a empresa no desafio descrito na vaga.".
...
Aceleração C#  pela Trybe- concluído em 2026
...
- com menos de 1500 caracteris ou 5 linhas o que for menor
...
- devolver apenas o resumo final e 3 tecnologias alinhadas com a vaga e os dados que te enviei.

output
{{resume: resumo, tec: [tec1, tec2, tec3]}}
""".strip())
